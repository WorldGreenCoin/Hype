...
In order to support loading of multiple wallets in hype-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hype.cpp.
...
Changes to hype.cpp
----------------------
hype.cpp is the entry point into hype-qt, and as such, will require some minor modifications to provide hooks for
