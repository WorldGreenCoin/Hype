/* src/config/hype-config.h.  Generated from hype-config.h.in by configure.  */
/* src/config/hype-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HYPE_CONFIG_H

#define HYPE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://hype.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hype Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hype Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hype"
