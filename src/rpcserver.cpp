...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HYPE features */
        {"hype", "masternode", &masternode, true, true, false},
        {"hype", "masternodelist", &masternodelist, true, true, false},
        {"hype", "mnbudget", &mnbudget, true, true, false},
        {"hype", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"hype", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hype", "mnsync", &mnsync, true, true, false},
        {"hype", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"hype", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hyped, or the -server option to hype-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> hype-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36051/\n";
}
