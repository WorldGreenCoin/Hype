...
RESOURCES += src/qt/hype.qrc src/qt/hype_locale.qrc

TRANSLATIONS += src/qt/locale/hype_bg.ts \
                src/qt/locale/hype_de.ts \
                src/qt/locale/hype_en.ts \
                src/qt/locale/hype_es.ts \
                src/qt/locale/hype_fi.ts \
                src/qt/locale/hype_fr.ts \
                src/qt/locale/hype_it.ts \
                src/qt/locale/hype_ja.ts \
                src/qt/locale/hype_pl.ts \
                src/qt/locale/hype_pt.ts \
                src/qt/locale/hype_ru.ts \
                src/qt/locale/hype_sk.ts \
                src/qt/locale/hype_sv.ts \
                src/qt/locale/hype_vi.ts \
                src/qt/locale/hype_zh_CN.ts \
                src/qt/locale/hype_zh_TW.ts
